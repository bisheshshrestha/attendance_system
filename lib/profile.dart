      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                icon: const Icon(Icons.image, size: 60, color: Colors.white),
                              ),
                            ],
                          ),
                        ],
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: selectedImage == null
                          ? const Icon(Icons.person, size: 70, color: Color(0xFF070046))
                          : null,
                    ),
                    CircleAvatar(
                      radius: 18,
            ...
            buildTextField(label: "Name", value: "Rahma Ahmed"),
